...
const TextInput = ({title, name, value,  placeholder, type}) => {
    return (
        <div className='relative w-full h-20'>
            ...
            <input type={type} name={name} placeholder={placeholder} value={value} className='w-full px-3 py-3 border-[3px] rounded-lg border-[#E1CEB6] focus:border-none active:border-none' />
        </div>
    )
}
